...
if __name__ == "__main__":
    ...
    parser.add_argument('--saved_path', type=str, default='Datasets/GS/0')
    parser.add_argument('--save_path', type=str, default='pretrained_models/GS/')
    ...
    parser.add_argument('--models', type=str, default='main')
