...
class Solver(object):
    ...
    def load_model(self, iter_,args):  # 测试的时候需要加载训练时候保存的模型
        f = os.path.join(self.save_path, '{}_{}.pth'.format(self.model,iter_))
        if self.multi_gpu:
            state_d = OrderedDict()
    ...
    def save_fig(self, x, y, pred, fig_name, original_result, pred_result):
        ...
        ax[2].set_title(' Free-Noise', fontsize=30)
    ...
    def test(self,args):
        ...
        with torch.no_grad():
            ...
            print('\n')
            print('Predictions === \nModel:{}-denoising network\nPSNR avg: {:.4f} \nSSIM avg: {:.4f} \nRMSE avg: {:.4f}'.format(self.model,pred_psnr_avg/len(self.data_loader),
